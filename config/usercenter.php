...
return [
    'help_center' => [
        ['title' => '如何申请一笔借款？',
            'text' => '用本人实名认证的手机号注册→完成认证信息的填写→申请借款金额与期限→申请通过→等待打款→收到打款 。'
        ],
        [
            'title' => '申请一笔借款需要多长时间？',
            'text' => '一般情况下，当天申请的借款当天就能通过审核，请您耐心等待。',
        ],
        [
            'title' => '如何提高申请通过率 ？',
            'text' => '
        ...
        [
            'title' => '借款费用是多少？',
            'text' => '根据您的信用情况，您会有不同的贷款产品选择，一般贷款月利率在0.1%-0.3%之间。',
        ],

        [
            'title' => '借款人需要具备哪些条件才能申请借款？',
            'text' => '18-55岁大陆公民，有稳定的收入来源，无不良信用记录，能满足以上三个条件者，均可以享受优质快捷的借款服务。',
        ],
        ...
        [
            'title' => '申请借款需要哪些认证信息？',
            'text' => '一般情况下需要认证的信息如下：个人信息认证、芝麻信用认证、通信运营商认证、收款银行卡绑定、通过这些认证过后即可申请借款。',
        ],

        [
            'title' => '审核通过后多久会打款？',
            'text' => '一般情况下审核大约需要1-3个工作日，请您耐心等待。',
        ],

        [
            'title' => '可以提前还款吗？',
            'text' => '根据您申请的贷款产品不同，情况也不一样，一般情况下，请保证在还款日账户上余额充足即可。',
        ]
    ],
    'privacy_policy' => [
